...
const DEFAULT_CONFIG: SavingsGroupConfig = {
  packageId: '0xc9be599a1ce3605fcccaf86a1cd857d09bdf7f5f2acc39b775d13b1cbff52c35',
  network: 'testnet'
};
 ...
 */
async function getSuiBalance(address : string, network = 'testnet' ) {
  try {
    ...
    const balance = await client.getBalance({
      owner: Ed25519Keypair.fromSecretKey(address).getPublicKey().toSuiAddress(),
